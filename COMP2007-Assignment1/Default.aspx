        ...
        <div class="row jumbotron">
            ...
            <div class="col-md-3">
                ...
                <div>
                    ...
                    <asp:RangeValidator ID="RangeValidatorScore1" ControlToValidate="pointScored1" CssClass="text-danger" Display="Dynamic" MaximumValue="10" MinimumValue="0" Type="Integer" runat="server" ErrorMessage="Scores should be between 0-10"></asp:RangeValidator>
                </div>
                ...
                <div>
                    ...
                    <asp:RangeValidator ID="RangeValidatorAllowed1" ControlToValidate="pointsAllowed1" CssClass="text-danger" Display="Dynamic" MaximumValue="10" MinimumValue="0" Type="Integer" runat="server" ErrorMessage="Points Allowed should be between 0-10"></asp:RangeValidator>
                </div>
                ...
                <div>
                    ...
                    <asp:RangeValidator ID="RangeValidatorSpectator1" ControlToValidate="sptTextbox1" CssClass="text-danger" Display="Dynamic" MaximumValue="10" MinimumValue="0" Type="Integer" runat="server" ErrorMessage="Spectator should be between 0-10"></asp:RangeValidator>
                </div>
            ...
            <div class="col-md-3 ">
                ...
                <div>
                    ...
                    <asp:RangeValidator ID="RangeValidatorScored2" ControlToValidate="pointScored2" CssClass="text-danger" Display="Dynamic" MaximumValue="10" MinimumValue="0" Type="Integer" runat="server" ErrorMessage="Scores should be between 0-10"></asp:RangeValidator>
                </div>
                ...
                <div>
                    ...
                    <asp:RangeValidator ID="RangeValidatorAllowed2" ControlToValidate="pointsAllowed2" CssClass="text-danger" Display="Dynamic" MaximumValue="10" MinimumValue="0" Type="Integer" runat="server" ErrorMessage="Points Allowed should be between 0-10"></asp:RangeValidator>
                ...
                <div>
                    ...
                    <asp:RangeValidator ID="RangeValidatorSpectator2" ControlToValidate="sptTextbox2" CssClass="text-danger" Display="Dynamic" MaximumValue="10" MinimumValue="0" Type="Integer" runat="server" ErrorMessage="Spectators should be between 0-10"></asp:RangeValidator>
            ...
            <div class="col-md-3">
                ...
                <div>
                    ...
                    <asp:RangeValidator ID="RangeValidatorScored3" ControlToValidate="pointScored3" CssClass="text-danger" Display="Dynamic" MaximumValue="10" MinimumValue="0" Type="Integer" runat="server" ErrorMessage="Scores should be between 0-10"></asp:RangeValidator>
                ...
                <div>
                    ...
                    <asp:RangeValidator ID="RangeValidatorAllowed" ControlToValidate="pointsAllowed3" CssClass="text-danger" Display="Dynamic" MaximumValue="10" MinimumValue="0" Type="Integer" runat="server" ErrorMessage="Points Allowed should be between 0-10"></asp:RangeValidator>
                ...
                <div>
                    ...
                    <asp:RangeValidator ID="RangeValidatorSpectator3" ControlToValidate="sptTextbox3" CssClass="text-danger" Display="Dynamic" MaximumValue="10" MinimumValue="0" Type="Integer" runat="server" ErrorMessage="Spectators should be between 0-10"></asp:RangeValidator>
            ...
            <div class="col-md-3">
                ...
                <div>
                    ...
                    <asp:RangeValidator ID="RangeValidatorScored4" ControlToValidate="pointScored4" CssClass="text-danger" Display="Dynamic" MaximumValue="10" MinimumValue="0" Type="Integer" runat="server" ErrorMessage="Scores should be between 0-10"></asp:RangeValidator>
                ...
                <div>
                    ...
                    <asp:RangeValidator ID="RangeValidatorAllowed4" ControlToValidate="pointsAllowed4" CssClass="text-danger" Display="Dynamic" MaximumValue="10" MinimumValue="0" Type="Integer" runat="server" ErrorMessage="Points Allowed should be between 0-10"></asp:RangeValidator>
                ...
                <div>
                    ...
                    <asp:RangeValidator ID="RangeValidatorSpectator4" ControlToValidate="sptTextbox4" CssClass="text-danger" Display="Dynamic" MaximumValue="10" MinimumValue="0" Type="Integer" runat="server" ErrorMessage="Spectators should be between 0-10"></asp:RangeValidator>
